...
const SignatureView = forwardRef(
  (
    ...
    console.log('SignatureView>>>>',SignatureView)
    ...
    const source = useMemo(() => {
      ...
      html = html.replace(/<%imgClear%>/g, imgClear);
    ...
    const onPress = () =>{
      console.log('adkasjhdaskdhaj')
      injectedApplication.clearSignature()
    }
